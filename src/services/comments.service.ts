...
export async function createComments(req: Request, res: Response) {
  try {
    ...
    console.log("erreur lors de la creation de commentaires", error)
...
export async function updateComment(req: Request, res: Response) {
  try {
    ...
    console.log("erreur lors de la mise a jour de commentaires", error)
...
export async function deleteComment(req: Request, res: Response) {
  try {
    ...
    console.log("erreur lors de la suppression de commentaires", error)
